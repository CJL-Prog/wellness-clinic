    ...
    <section id="membership" className="py-20 bg-neutral-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          {/* Billing toggle */}
          <div className="inline-flex items-center brutal-card bg-white p-1">
            <button
            ...
            >
              {plan.popular && (
                <div className="absolute -top-4 left-0 right-0 flex justify-center">
                  <span className="bg-gradient-to-r from-emerald-600 to-emerald-500 text-white px-4 py-1 rounded-full text-sm font-bold border-2 border-black">
                    MOST POPULAR
                  </span>
                </div>
              )}
              ...
              `}>
                ...
                <Link
                  ...
                  className={plan.popular ? 'brutal-button w-full text-center' : 'brutal-button-secondary w-full text-center'}
                >
                  {plan.cta}
                </Link>
              </div>
