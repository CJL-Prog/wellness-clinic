...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 flex items-center justify-center px-6 py-12">
            ...
            <>
              ...
              <div className="mt-6 text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <Link href="/intake" className="text-blue-600 hover:text-blue-700 font-medium">
                    Get Started
                  </Link>
                </p>
              </div>
