  ...
  return (
    <div className="min-h-screen bg-neutral-50 pt-24 pb-12">
      <div className="max-w-4xl mx-auto px-6">
        <h1 className="text-4xl font-bold mb-8 gradient-text-hero">Shipping & Returns</h1>
        ...
        <div className="brutal-card bg-white space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-bold mb-2">Shipping Methods</h3>
              ...
              <div>
                <h3 className="text-lg font-bold mb-2">Temperature-Controlled Shipping</h3>
                <p className="text-neutral-600">
              ...
              <div>
                <h3 className="text-lg font-bold mb-2">Discreet Packaging</h3>
                <p className="text-neutral-600">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-bold mb-2">Tracking Your Order</h3>
                <p className="text-neutral-600">
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-bold mb-2">Damaged or Incorrect Orders</h3>
                <p className="text-neutral-600">
              ...
              <div>
                <h3 className="text-lg font-bold mb-2">Lost or Stolen Packages</h3>
                <p className="text-neutral-600">
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-bold mb-2">State Restrictions</h3>
              ...
              <div>
                <h3 className="text-lg font-bold mb-2">International Shipping</h3>
                <p className="text-neutral-600">
          ...
          <section className="glass-card rounded-lg p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a 
                ...
                className="inline-flex items-center justify-center gap-2 px-4 py-2 bg-white text-emerald-600 rounded-lg font-bold hover:bg-neutral-50 border-2 border-black"
              ...
              <a 
                ...
                className="inline-flex items-center justify-center gap-2 brutal-button"
              >
                Call 1-800-XXX-XXXX
              </a>
            </div>
