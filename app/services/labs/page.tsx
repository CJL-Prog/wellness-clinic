    ...
    <div className="pt-24 pb-20">
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold mb-4">Advanced Lab Testing</h1>
        ...
        <div className="bg-gray-50 rounded-2xl p-8 mb-12">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {addOns.map(addon => (
              <label
                key={addon.name}
                className="flex items-start gap-3 p-4 bg-white rounded-lg cursor-pointer hover:shadow-md transition-shadow"
              >
                <input
                  type="checkbox"
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm font-semibold text-blue-600 mt-1">+${addon.price}</div>
                </div>
              </label>
            ))}
          </div>
